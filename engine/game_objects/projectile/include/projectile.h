...
class Projectile : public GameObject<Projectile> {
public:

    Projectile(ecs::Engine *engine, ecs::ComponentManager* instance, sf::Vector2f pos) : m_startPos(pos), m_engine(engine), GameObject(engine, instance) {}
